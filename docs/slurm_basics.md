...
Follow the directions in [X Forwarding for Mac and Windows](https://researchit.las.iastate.edu/x-forwarding-mac-and-windows). Be sure to add the -X flag to your ssh command when connecting to pronto.
